...
function sendMessage() {
  timeEl.textContent =
    "Finished!! You got " + score + " out of 8 questions right!!";
}
...
function questionThree() {
  ...
  optionA3.textContent =
    "A) Makes the function associated with it execute first";
  optionB3.textContent =
    "B) Makes the function associated with it execute last";
...
function questionFour() {
  ...
  optionD4.textContent =
    "D) The result contains something (String, numbers, true, etc)";
...
function questionEight() {
  ...
  optionD8.textContent =
    "D) Creates a callback function to execute when the user interacts with the site";
